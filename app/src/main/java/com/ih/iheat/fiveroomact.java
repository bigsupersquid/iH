...
public class fiveroomact extends Activity implements OnClickListener {
	View iv[]=new View[6];
	ImageView degree[]=new ImageView[6];
		...
		public void run()
		{
			...
			while((i<result.length)&&(i<5))
			{
				String r=result[i];
					...
					{
//                        if (i < 2)
//                            iv[i].setBackgroundResource(R.drawable.cold_small);
//                        else
//                            iv[i].setBackgroundResource(R.drawable.cold_smaller);
					}
					else
					{
					if (i < 2)
